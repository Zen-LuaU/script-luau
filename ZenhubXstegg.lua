--[[
    ...
    [MOD] Teleport-to-egg steal + Walk-back return
--]]
...
-- ============================================================
-- [MOD] stealEgg: TELEPORT tới trứng → lấy → ĐI BỘ về base
-- ============================================================
function H.stealEgg(slotEgg)
    ...
    -- BƯỚC 1: TELEPORT thẳng đến vị trí trứng
    do
        root = H.getRoot()
        if root then
    ...
    -- BƯỚC 2: Giữ vị trí + cố gắng nhặt trứng
    ...
    -- BƯỚC 3: Retry nhặt trứng trong 2.5s (vẫn teleport giữ vị trí)
    ...
    -- BƯỚC 4: Giữ vị trí thêm 3s để server xác nhận đang mang trứng
    ...
    -- BƯỚC 5: DI CHUYỂN VỀ base (KHÔNG teleport) — dùng BodyVelocity move
