...
local dict = {
    vi = {
        ...
        tag = "v14.0 - Bản Hợp Nhất",
        notify_loaded = "Đã load! Nhấn nút bên trái để mở menu.",
        copy_discord = "Đã sao chép link Discord!",
        ...
        tab_anti = "Bảo Vệ",
        tab_system = "Hệ Thống",
        sec_steal = "Cướp Trứng",
        sec_steal_free = "Cướp Trứng Tự Do",
        sec_egg_handle = "Xử Lý Trứng",
        sec_priority = "Ưu Tiên Nhiệm Vụ",
        sec_hop = "Chuyển Server",
        sec_pets_ov = "Tổng Quan Thú Cưng",
        sec_fuse = "Ghép Thú",
        sec_sell_pets = "Bán Thú Cưng",
        sec_visual = "Thú Ảo (Chỉ Hiện Client)",
        sec_upgrade = "Nâng Cấp",
        sec_rewards = "Phần Thưởng",
        sec_equip = "Trang Bị",
        sec_train = "Luyện Tập",
        sec_esp = "ESP",
        sec_move = "Di Chuyển",
        sec_tp = "Dịch Chuyển",
        sec_anti_rag = "Chống Văng / Chống Knock",
        sec_session = "Phiên Chơi",
        sec_perf = "Hiệu Suất",
        sec_webhook = "Webhook",
        sec_about = "Giới Thiệu",
        t_steal_selected = "Tự Động Cướp Đã Chọn",
        d_steal_selected = "Dùng bộ lọc bên dưới",
        t_steal_all = "Tự Động Cướp Tất Cả",
        d_steal_all = "Bỏ qua độ hiếm / biến thể",
        t_steal_big = "Cướp Trứng To",
        t_areas = "Khu Vực",
        t_rarities = "Độ Hiếm",
        t_mutations = "Biến Thể",
        t_priority = "Ưu Tiên Mục Tiêu",
        t_big_size = "Kích Thước Trứng To Tối Thiểu",
        t_return_base = "Tự Động Về Base",
        t_drop_egg = "Tự Động Bỏ Trứng",
        t_steal_now = "Cướp Ngay",
        t_bypass = "Bypass Anti-Cheat + Tốc Độ",
        d_bypass = "Nhân bản Humanoid để vượt filter",
        t_walkspeed_on = "Bật/Tắt Tốc Độ Đi",
        t_walkspeed = "Tốc Độ Di Chuyển",
        t_speed_changer = "Đổi Tốc Độ (Anti-Cheat)",
        t_void_unstuck = "Thoát Kẹt Void",
        t_set_base = "Đặt Base Tại Đây",
        t_clear_base = "Xóa Điểm Base",
        t_steal_free_on = "Bật Cướp Trứng Tự Do",
        d_steal_free = "Phát hiện RUN!! + Drop → chạy về base",
        t_place_sel = "Tự Động Đặt Đã Chọn",
        t_place_all = "Tự Động Đặt Tất Cả",
        t_life_rar = "Độ Hiếm Vòng Đời",
        t_life_mut = "Biến Thể Vòng Đời",
        t_place_now = "Đặt Ngay",
        t_hatch = "Tự Động Nở Trứng Sẵn Sàng",
        t_hatch_now = "Nở Ngay",
        t_sell_eggs = "Tự Động Bán Trứng",
        t_sell_rar_egg = "Độ Hiếm Bán",
        t_sell_interval = "Chu Kỳ Bán",
        t_equip_best = "Tự Động Trang Bị Tốt Nhất",
        t_hide_pets = "Ẩn Thú Cưng Của Mình",
        t_fuse_on = "Tự Động Ghép Thú",
        t_fuse_rar = "Độ Hiếm Ghép",
        t_fuse_mut = "Biến Thể Ghép",
        t_fuse_pick = "Chọn Nhóm Theo",
        t_fuse_keep_mut = "Không Ghép Thú Biến Thể",
        t_fuse_keep_eq = "Không Ghép Thú Đang Dùng",
        t_fuse_reveal = "Tự Động Hoàn Thành Tiết Lộ",
        t_fuse_max_scale = "Kích Thước Tối Đa Để Ghép",
        t_fuse_keep_cat = "Giữ Lại Mỗi Loại",
        t_fuse_int = "Chu Kỳ Ghép",
        t_fuse_now = "Ghép Ngay",
        t_sell_pets = "Tự Động Bán Thú",
        t_sell_rar = "Độ Hiếm Bán",
        t_sell_mut = "Biến Thể Bán",
        t_sell_keep_mut = "Không Bán Thú Biến Thể",
        t_sell_keep_eq = "Không Bán Thú Đang Dùng",
        t_sell_max = "Kích Thước Tối Đa Để Bán",
        t_pet = "Thú Cưng",
        t_refresh_list = "Làm Mới Danh Sách",
        t_custom_name = "Tên Tùy Chỉnh",
        t_orbit_radius = "Bán Kính Quỹ Đạo",
        t_orbit_speed = "Tốc Độ Quay",
        t_spawn_pet = "Triệu Hồi Thú",
        t_rm_last = "Xóa Con Cuối",
        t_rm_all = "Xóa Tất Cả",
        t_auto_upgrade = "Tự Động Mua Nâng Cấp",
        t_upgrade_types = "Loại Nâng Cấp",
        t_claim_index = "Tự Động Nhận Index",
        t_claim_group = "Nhận Phần Thưởng Nhóm",
        t_claim_offline = "Nhận Thu Nhập Offline",
        t_buy_trail = "Tự Động Mua Vệt",
        t_trails = "Vệt",
        t_eq_best_trail = "Trang Bị Vệt Tốt Nhất",
        t_eq_best_gear = "Trang Bị Đồ Tốt Nhất",
        t_treadmill = "Tự Động Luyện Treadmill",
        t_esp_world = "ESP Trứng Ngoài Map",
        t_esp_carry = "ESP Trứng Đang Cầm/Rớt",
        t_esp_guard = "ESP Bảo Vệ",
        t_esp_pet = "ESP Thú Cưng",
        t_esp_player = "ESP Người Chơi",
        t_esp_machine = "ESP Máy Móc",
        t_esp_plot = "ESP Khu Đất",
        t_esp_dist = "Khoảng Cách Hiển Thị",
        t_ws_override = "Ghi Đè Tốc Độ Đi",
        t_jump_override = "Ghi Đè Lực Nhảy",
        t_inf_jump = "Nhảy Vô Hạn",
        t_noclip = "Xuyên Vật Thể",
        t_fly = "Bay",
        t_fly_speed = "Tốc Độ Bay",
        t_waypoint = "Điểm Đến",
        t_tp_way = "Dịch Chuyển Đến Điểm",
        t_drop_void = "Thả Xuống Void",
        t_hop_on = "Tự Động Chuyển Server",
        t_hop_when = "Chuyển Khi",
        t_hop_wait = "Chờ Trước Khi Chuyển",
        t_hop_now = "Chuyển Ngay",
        t_rejoin = "Vào Lại Server",
        t_anti_rag = "Chống Văng / Chống Knock",
        t_anti_trap = "Chống Bẫy (Xóa & Ẩn)",
        t_instant_hold = "Bỏ Qua Ấn Giữ (Tương Tác Nhanh)",
        t_fix_lag = "Bật Fix Lag Đất Sét",
        t_anti_afk = "Chống AFK",
        t_no_pause = "Không Bị Tạm Dừng",
        t_auto_rec = "Tự Động Kết Nối Lại",
        t_fps_boost = "Tăng FPS",
        t_disable_render = "Tắt Render 3D",
        t_fps_cap = "Giới Hạn FPS",
        t_webhook_on = "Bật Webhook",
        t_webhook_url = "URL Webhook",
        t_webhook_ping = "Ping User ID",
        t_webhook_int = "Chu Kỳ Tóm Tắt (phút)",
        t_webhook_dc = "Cảnh Báo Mất Kết Nối",
        t_send_sum = "Gửi Tóm Tắt Ngay",
        t_copy_dis = "Sao Chép Link Discord",
        t_unload = "Tắt Script",
        t_language = "Ngôn Ngữ",
        t_lang_vi = "Tiếng Việt",
        t_lang_en = "English",
    },
    en = {
        menu_title = "zen hubX steal an egg",
        open_btn = "Open zen hubX Menu",
        tag = "v14.0 - Ultimate Merged",
        notify_loaded = "Loaded! Press the left button to open the menu.",
        copy_discord = "Discord link copied!",
        ...
        tab_player = "Player",
        tab_anti = "Anti Features",
        tab_system = "System",
        sec_steal = "Steal Eggs",
        sec_steal_free = "Auto Steal Free",
        sec_egg_handle = "Egg Handling",
        sec_priority = "Task Priority",
        sec_hop = "Server Hop",
        sec_pets_ov = "Pets Overview",
        sec_fuse = "Auto Fuse",
        sec_sell_pets = "Auto Sell Pets",
        sec_visual = "Visual Pets (Client Only)",
        sec_upgrade = "Upgrades",
        sec_rewards = "Rewards",
        sec_equip = "Equipment",
        sec_train = "Training",
        sec_esp = "ESP",
        sec_move = "Movement",
        sec_tp = "Teleports",
        sec_anti_rag = "Anti-Ragdoll / Anti-Knock",
        sec_session = "Session",
        sec_perf = "Performance",
        sec_webhook = "Webhooks",
        sec_about = "About",
        t_steal_selected = "Auto Steal Selected",
        d_steal_selected = "Use filters below",
        t_steal_all = "Auto Steal All",
        d_steal_all = "Ignore rarity / mutation",
        t_steal_big = "Steal Big Eggs",
        t_areas = "Areas",
        t_rarities = "Rarities",
        t_mutations = "Mutations",
        t_priority = "Target Priority",
        t_big_size = "Minimum Big Egg Size",
        t_return_base = "Auto Return to Base",
        t_drop_egg = "Auto Drop Held Egg",
        t_steal_now = "Steal Now",
        t_bypass = "Bypass Anti-Cheat + Speed",
        d_bypass = "Clone Humanoid to bypass filter",
        t_walkspeed_on = "Toggle WalkSpeed",
        t_walkspeed = "Walk Speed",
        t_speed_changer = "Speed Changer (Anti-Cheat)",
        t_void_unstuck = "Void Unstuck",
        t_set_base = "Set Base Here",
        t_clear_base = "Clear Base Pin",
        t_steal_free_on = "Enable Auto Steal Free",
        d_steal_free = "Detect RUN!! + Drop → walk back to base",
        t_place_sel = "Auto Place Selected",
        t_place_all = "Auto Place All",
        t_life_rar = "Lifecycle Rarities",
        t_life_mut = "Lifecycle Mutations",
        t_place_now = "Place Now",
        t_hatch = "Auto Hatch Ready",
        t_hatch_now = "Hatch Now",
        t_sell_eggs = "Auto Sell Eggs",
        t_sell_rar_egg = "Sell Rarities",
        t_sell_interval = "Sell Interval",
        t_equip_best = "Auto Equip Best",
        t_hide_pets = "Hide Own Pet Renders",
        t_fuse_on = "Auto Fuse Pets",
        t_fuse_rar = "Fuse Rarities",
        t_fuse_mut = "Fuse Mutations",
        t_fuse_pick = "Pick Group By",
        t_fuse_keep_mut = "Never Fuse Mutated",
        t_fuse_keep_eq = "Never Fuse Equipped",
        t_fuse_reveal = "Auto Complete Reveal",
        t_fuse_max_scale = "Max Scale to Fuse",
        t_fuse_keep_cat = "Keep Per Pet Type",
        t_fuse_int = "Fuse Interval",
        t_fuse_now = "Fuse Now",
        t_sell_pets = "Auto Sell Pets",
        t_sell_rar = "Sell Rarities",
        t_sell_mut = "Sell Mutations",
        t_sell_keep_mut = "Never Sell Mutated",
        t_sell_keep_eq = "Never Sell Equipped",
        t_sell_max = "Max Scale to Sell",
        t_pet = "Pet",
        t_refresh_list = "Refresh Pet List",
        t_custom_name = "Custom Name",
        t_orbit_radius = "Orbit Radius",
        t_orbit_speed = "Orbit Speed",
        t_spawn_pet = "Spawn Pet",
        t_rm_last = "Remove Last Pet",
        t_rm_all = "Remove All",
        t_auto_upgrade = "Auto Buy Upgrades",
        t_upgrade_types = "Upgrade Types",
        t_claim_index = "Auto Claim Index",
        t_claim_group = "Auto Claim Group Reward",
        t_claim_offline = "Claim Offline Earnings",
        t_buy_trail = "Auto Buy Trail",
        t_trails = "Trails",
        t_eq_best_trail = "Auto Equip Best Trail",
        t_eq_best_gear = "Auto Equip Best Gear",
        t_treadmill = "Auto Treadmill Training",
        t_esp_world = "World Egg ESP",
        t_esp_carry = "Carried/Dropped Egg ESP",
        t_esp_guard = "Guard ESP",
        t_esp_pet = "Pet ESP",
        t_esp_player = "Player ESP",
        t_esp_machine = "Machine ESP",
        t_esp_plot = "Plot ESP",
        t_esp_dist = "Render Distance",
        t_ws_override = "Walk Speed Override",
        t_jump_override = "Jump Power Override",
        t_inf_jump = "Infinite Jump",
        t_noclip = "NoClip",
        t_fly = "Fly",
        t_fly_speed = "Fly Speed",
        t_waypoint = "Waypoint",
        t_tp_way = "Teleport to Waypoint",
        t_drop_void = "Drop to Void",
        t_hop_on = "Auto Server Hop",
        t_hop_when = "Hop When",
        t_hop_wait = "Wait Before Hop",
        t_hop_now = "Hop Now",
        t_rejoin = "Rejoin Server",
        t_anti_rag = "Anti-Ragdoll (Anti-Knock)",
        t_anti_trap = "Anti Trap (Delete & Hide)",
        t_instant_hold = "Instant Interact",
        t_fix_lag = "Enable Clay Fix Lag",
        t_anti_afk = "Anti-AFK",
        t_no_pause = "No Gameplay Paused",
        t_auto_rec = "Auto Reconnect",
        t_fps_boost = "FPS Boost",
        t_disable_render = "Disable 3D Rendering",
        t_fps_cap = "FPS Cap",
        t_webhook_on = "Enable Webhooks",
        t_webhook_url = "Webhook URL",
        t_webhook_ping = "Ping User ID",
        t_webhook_int = "Summary Interval (min)",
        t_webhook_dc = "Disconnect Alerts",
        t_send_sum = "Send Summary Now",
        t_copy_dis = "Copy Discord Link",
        t_unload = "Unload Script",
        t_language = "Language",
        t_lang_vi = "Tiếng Việt",
        t_lang_en = "English",
    }
}
function L.T(key) return (dict[Lang] and dict[Lang][key]) or key end
...
-- 🔧 Cấu hình mới cho step teleport (fix độ trễ về base)
local StepTeleportConfig = {
    Step = 18,      -- Kích thước mỗi nấc (studs)
    Delay = 0.04,   -- Delay giữa các nấc (giây)
    Arrive = 3,     -- Khoảng cách coi như đã tới
}
...
function H.recordMutations(asset)
    ...
    if typeof(asset.Mutations) == "table" then
        for _, mutation in pairs(asset.Mutations) do if typeof(mutation) == "string" then table.insert(mutations, mutation) end end
    end
...
-- 🔧 HÀM MỚI: Kiểm tra đã có vật phẩm trong tay/balo chưa
...
-- 🔧 HÀM MỚI: Step Teleport mượt, phát hiện rớt trứng
function H.nonLagStepTeleport(targetCFrame, checkDrop)
    ...
    for i = 1, totalSteps do
        ...
        -- Nếu đang cầm trứng mà rớt thì ngắt
        if checkDrop and not H.hasItemAcquired() then
            success = false
            break
        end
...
-- 🔧 BYPASS MOVE: dùng StepTeleport mới kết hợp BodyVelocity
function H.bypassMoveTo(position, keepGoing, speed)
    if typeof(position) ~= "Vector3" or not running then return false end
    -- Dùng step teleport nếu khoảng cách xa để nhanh hơn
    local root = H.getRoot(); if not root then return false end
...
-- 🔧 STEAL EGG: Dùng step teleport với phát hiện rớt, không còn delay
function H.stealEgg(slotEgg)
    ...
    -- Bước 2: Gửi remote nhặt trứng và chờ xác nhận
...
function H.runAutoReturn()
    if not IsCarryingEgg then return false end
    local keep = function() return H.isOn("AutoReturn") and IsCarryingEgg end
    local base = H.getBasePosition()
    if not base then return false end
    local baseY = H.groundedY(base.X, base.Z, base.Y)
    local baseCF = CFrame.new(base.X, baseY + 3, base.Z)
    -- ✅ StepTeleport với checkDrop = true
...
RunService.Stepped:Connect(function()
    if SpeedConfig.Enabled then
        local hum = H.getHumanoid()
        if hum and hum.WalkSpeed ~= SpeedConfig.Value then hum.WalkSpeed = SpeedConfig.Value end
    end
end)
...
Window:Tag({ Title = L.T("tag"), Icon = "solar:star-bold", Color = PurpleColor, Border = true })

-- ============================================================
-- 🌐 NÚT CHUYỂN NGÔN NGỮ Ở GÓC PHẢI
-- ============================================================
local LanguageGui = Instance.new("ScreenGui")
LanguageGui.Name = "ZenHubX_LangToggle"
LanguageGui.ResetOnSpawn = false
LanguageGui.IgnoreGuiInset = true
...
LangBtn.Size = UDim2.fromOffset(96, 34)
LangBtn.Position = UDim2.new(1, -110, 0, 12)
LangBtn.BackgroundColor3 = Color3.fromRGB(18, 18, 24)
...
LBStroke.Color = PurpleColor
LBStroke.Thickness = 1.5
LBStroke.Parent = LangBtn

LangBtn.MouseButton1Click:Connect(function()
    -- Đổi ngôn ngữ
    if Lang == "vi" then Lang = "en" else Lang = "vi" end
    LangBtn.Text = (Lang == "vi") and "🇻🇳 Tiếng Việt" or "🇬🇧 English"
    -- Thông báo và yêu cầu reload để áp dụng
    pcall(function()
        WindUI:Notify({
            Title = "ZenHubX",
            Content = (Lang == "vi") and "Đã đổi sang Tiếng Việt! Chạy lại script để áp dụng đầy đủ." or "Changed to English! Re-run script to fully apply.",
            Duration = 5,
        })
    end)
end)
...
-- ============================================================
-- TAB 1: NÔNG TRẠI (Farm) - Gộp Steal, Steal Free, Egg Handling, Priority
-- ============================================================
local FarmTab = Window:Tab({ Title = L.T("tab_farm"), Icon = "solar:zap-bold", IconColor = PurpleColor, Border = true })

-- Section: Cướp Trứng
FarmTab:Section({ Title = L.T("sec_steal") })
FarmTab:Toggle({ Title = L.T("t_steal_selected"), Desc = L.T("d_steal_selected"), Value = false, Callback = function(v) UIState["AutoStealSelected"] = v end })
FarmTab:Toggle({ Title = L.T("t_steal_all"), Desc = L.T("d_steal_all"), Value = false, Callback = function(v) UIState["AutoStealAll"] = v end })
FarmTab:Toggle({ Title = L.T("t_steal_big"), Value = false, Callback = function(v) UIState["StealBigEggs"] = v end })
FarmTab:Dropdown({ Title = L.T("t_areas"), Values = AreaNames, Multi = true, Value = {}, Callback = function(v) UIValues["StealZones"] = v end })
FarmTab:Dropdown({ Title = L.T("t_rarities"), Values = RARITIES, Multi = true, Value = {}, Callback = function(v) UIValues["StealRarities"] = v end })
FarmTab:Dropdown({ Title = L.T("t_mutations"), Values = MUTATIONS, Multi = true, Value = {}, Callback = function(v) UIValues["StealMutations"] = v end })
FarmTab:Dropdown({ Title = L.T("t_priority"), Values = STEAL_PRIORITIES, Value = "Rarest", Callback = function(v) UIValues["StealPriority"] = v end })
FarmTab:Slider({ Title = L.T("t_big_size"), Min = 1, Max = 50, Default = 1.5, Step = 0.1, Callback = function(v) UIValues["StealBigEggScale"] = v end })
FarmTab:Toggle({ Title = L.T("t_return_base"), Value = true, Callback = function(v) UIState["AutoReturn"] = v end })
FarmTab:Toggle({ Title = L.T("t_drop_egg"), Value = false, Callback = function(v) UIState["AutoDropEgg"] = v end })
FarmTab:Button({ Title = L.T("t_steal_now"), Callback = function() task.spawn(H.runAutoSteal) end })

-- Section: Anti-Cheat Bypass
FarmTab:Section({ Title = "Anti-Cheat" })
FarmTab:Button({ Title = L.T("t_bypass"), Desc = L.T("d_bypass"), Callback = function()
    task.spawn(function()
        local ok = H.applyNewBypassAndSpeed()
        WindUI:Notify({ Title = "ZenHubX", Content = ok and "✓ Bypass OK" or "Error" })
    end)
end })
FarmTab:Toggle({ Title = L.T("t_walkspeed_on"), Value = false, Callback = function(v)
    SpeedConfig.Enabled = v
    local hum = H.getHumanoid()
    if hum then hum.WalkSpeed = v and SpeedConfig.Value or OriginalWalkSpeed end
end })
FarmTab:Slider({ Title = L.T("t_walkspeed"), Min = 100, Max = 900, Default = 300, Step = 10, Callback = function(v)
    SpeedConfig.Value = v
    if SpeedConfig.Enabled then local hum = H.getHumanoid(); if hum then hum.WalkSpeed = v end end
end })
FarmTab:Toggle({ Title = L.T("t_speed_changer"), Value = false, Callback = function(v) UIState["SpeedChanger"] = v end })
FarmTab:Toggle({ Title = L.T("t_void_unstuck"), Value = false, Callback = function(v) VoidUnstuck = v end })
FarmTab:Button({ Title = L.T("t_set_base"), Callback = function()
    local hrp = H.getRoot()
    if hrp then ManualBase = hrp.Position; WindUI:Notify({ Title = "Base", Content = "Đã pin base!" }) end
end })
FarmTab:Button({ Title = L.T("t_clear_base"), Callback = function() ManualBase = nil; WindUI:Notify({ Title = "Base", Content = "Đã xoá pin." }) end })

-- Section: Xử Lý Trứng
FarmTab:Section({ Title = L.T("sec_egg_handle") })
FarmTab:Toggle({ Title = L.T("t_place_sel"), Value = false, Callback = function(v) UIState["AutoPlaceSelected"] = v end })
FarmTab:Toggle({ Title = L.T("t_place_all"), Value = false, Callback = function(v) UIState["AutoPlaceAll"] = v end })
FarmTab:Dropdown({ Title = L.T("t_life_rar"), Values = RARITIES, Multi = true, Value = {}, Callback = function(v) UIValues["LifecycleRarities"] = v end })
FarmTab:Dropdown({ Title = L.T("t_life_mut"), Values = MUTATIONS, Multi = true, Value = {}, Callback = function(v) UIValues["LifecycleMutations"] = v end })
FarmTab:Button({ Title = L.T("t_place_now"), Callback = function() task.spawn(function() H.runAutoPlaceEggs(true) end) end })
FarmTab:Toggle({ Title = L.T("t_hatch"), Value = false, Callback = function(v) UIState["AutoOpenReadyEggs"] = v end })
FarmTab:Button({ Title = L.T("t_hatch_now"), Callback = function() task.spawn(function() H.runAutoOpenReadyEggs() end) end })
FarmTab:Toggle({ Title = L.T("t_sell_eggs"), Value = false, Callback = function(v) UIState["AutoSellEggs"] = v end })
FarmTab:Dropdown({ Title = L.T("t_sell_rar_egg"), Values = RARITIES, Multi = true, Value = {}, Callback = function(v) UIValues["SellEggRarities"] = v end })
FarmTab:Slider({ Title = L.T("t_sell_interval"), Min = 1, Max = 120, Default = 8, Step = 1, Callback = function(v) UIValues["SellEggInterval"] = v end })

-- Section: Ưu Tiên
FarmTab:Section({ Title = L.T("sec_priority") })
...
-- Section: Chuyển Server
FarmTab:Section({ Title = L.T("sec_hop") })
FarmTab:Toggle({ Title = L.T("t_hop_on"), Value = false, Callback = function(v) UIState["AutoServerHop"] = v end })
FarmTab:Dropdown({ Title = L.T("t_hop_when"), Values = ServerHopModes, Value = "No Matching Eggs", Callback = function(v) UIValues["HopMode"] = v end })
FarmTab:Slider({ Title = L.T("t_hop_wait"), Min = 1, Max = 200, Default = 15, Step = 1, Callback = function(v) UIValues["HopValue"] = v end })
FarmTab:Button({ Title = L.T("t_hop_now"), Callback = function() task.spawn(function() ServerHopRetryAfter = 0; H.serverHop("Manual") end) end })
FarmTab:Button({ Title = L.T("t_rejoin"), Callback = function() H.rejoinServer() end })

-- Section: Auto Steal Free
FarmTab:Section({ Title = L.T("sec_steal_free") })
FarmTab:Toggle({ Title = L.T("t_steal_free_on"), Desc = L.T("d_steal_free"), Value = false, Callback = function(v) UIState["AutoStealFree"] = v end })

-- ============================================================
-- TAB 2: THÚ CƯNG (Pets) - Gộp Pets, Fuse, Sell, Visual
-- ============================================================
local PetsTab = Window:Tab({ Title = L.T("tab_pets"), Icon = "solar:cat-bold", IconColor = PurpleColor, Border = true })

PetsTab:Section({ Title = L.T("sec_pets_ov") })
PetsTab:Toggle({ Title = L.T("t_equip_best"), Value = false, Callback = function(v) UIState["AutoEquipBest"] = v end })
PetsTab:Toggle({ Title = L.T("t_hide_pets"), Value = false, Callback = function(v) UIState["AutoDeleteOwnPets"] = v end })

PetsTab:Section({ Title = L.T("sec_fuse") })
PetsTab:Toggle({ Title = L.T("t_fuse_on"), Value = false, Callback = function(v) UIState["AutoFusePets"] = v end })
PetsTab:Dropdown({ Title = L.T("t_fuse_rar"), Values = RARITIES, Multi = true, Value = {}, Callback = function(v) UIValues["FuseRarities"] = v end })
PetsTab:Dropdown({ Title = L.T("t_fuse_mut"), Values = MUTATIONS, Multi = true, Value = {}, Callback = function(v) UIValues["FuseMutations"] = v end })
PetsTab:Dropdown({ Title = L.T("t_fuse_pick"), Values = FUSE_TARGET_MODES, Value = "Highest Rarity", Callback = function(v) UIValues["FuseTarget"] = v end })
PetsTab:Toggle({ Title = L.T("t_fuse_keep_mut"), Value = true, Callback = function(v) UIState["FuseKeepMutated"] = v end })
PetsTab:Toggle({ Title = L.T("t_fuse_keep_eq"), Value = true, Callback = function(v) UIState["FuseKeepEquipped"] = v end })
PetsTab:Toggle({ Title = L.T("t_fuse_reveal"), Value = true, Callback = function(v) UIState["FuseAutoReveal"] = v end })
PetsTab:Slider({ Title = L.T("t_fuse_max_scale"), Min = 0, Max = 10, Default = 10, Step = 0.1, Callback = function(v) UIValues["FuseMaxScale"] = v end })
PetsTab:Slider({ Title = L.T("t_fuse_keep_cat"), Min = 0, Max = 20, Default = 0, Step = 1, Callback = function(v) UIValues["FuseKeepPerCategory"] = v end })
PetsTab:Slider({ Title = L.T("t_fuse_int"), Min = 1, Max = 120, Default = 8, Step = 1, Callback = function(v) UIValues["FuseInterval"] = v end })
PetsTab:Button({ Title = L.T("t_fuse_now"), Callback = function() task.spawn(function() H.runAutoFusePets(true) end) end })

PetsTab:Section({ Title = L.T("sec_sell_pets") })
PetsTab:Toggle({ Title = L.T("t_sell_pets"), Value = false, Callback = function(v) UIState["AutoSellPets"] = v end })
PetsTab:Dropdown({ Title = L.T("t_sell_rar"), Values = RARITIES, Multi = true, Value = {}, Callback = function(v) UIValues["SellRarities"] = v end })
PetsTab:Dropdown({ Title = L.T("t_sell_mut"), Values = MUTATIONS, Multi = true, Value = {}, Callback = function(v) UIValues["SellMutations"] = v end })
PetsTab:Toggle({ Title = L.T("t_sell_keep_mut"), Value = true, Callback = function(v) UIState["SellKeepMutated"] = v end })
PetsTab:Toggle({ Title = L.T("t_sell_keep_eq"), Value = true, Callback = function(v) UIState["SellKeepEquipped"] = v end })
PetsTab:Slider({ Title = L.T("t_sell_max"), Min = 0, Max = 10, Default = 10, Step = 0.1, Callback = function(v) UIValues["SellMaxScale"] = v end })
PetsTab:Slider({ Title = L.T("t_sell_interval"), Min = 1, Max = 120, Default = 6, Step = 1, Callback = function(v) UIValues["SellInterval"] = v end })

PetsTab:Section({ Title = L.T("sec_visual") })
local visPetList = PetsTab:Dropdown({ Title = L.T("t_pet"), Values = {"Scanning..."}, Value = 1, Callback = function(v)
    local name = type(v) == "table" and next(v) or v
    if type(name) == "string" then UIValues["VisualPetSelected"] = name end
end })
PetsTab:Button({ Title = L.T("t_refresh_list"), Callback = function()
    ...
    if #names > 0 then
        ...
        WindUI:Notify({ Title = "Visual Pets", Content = "Không tìm thấy pet nào." })
    end
end })
PetsTab:Input({ Title = L.T("t_custom_name"), Placeholder = "e.g. Dragon", Callback = function(v) UIValues["VisualPetCustom"] = v end })
PetsTab:Slider({ Title = L.T("t_orbit_radius"), Min = 2, Max = 20, Default = 4, Step = 1, Callback = function(v) UIValues["VisualPetRadius"] = v end })
PetsTab:Slider({ Title = L.T("t_orbit_speed"), Min = 0, Max = 10, Default = 1, Step = 1, Callback = function(v) UIValues["VisualPetSpeed"] = v end })
PetsTab:Button({ Title = L.T("t_spawn_pet"), Callback = function()
...
PetsTab:Button({ Title = L.T("t_rm_last"), Callback = function()
    local v = table.remove(VisualPetsSpawned); if v then pcall(function() v.model:Destroy() end) end
end })
PetsTab:Button({ Title = L.T("t_rm_all"), Callback = function() H.clearVisualPets(); WindUI:Notify({ Title = "Visual Pets", Content = "Đã xoá hết." }) end })
...
-- ============================================================
-- TAB 3: TIẾN TRÌNH (Progress) - Gộp Upgrades, Rewards, Equipment, Training
-- ============================================================
local ProgTab = Window:Tab({ Title = L.T("tab_progress"), Icon = "solar:graph-up-bold", IconColor = PurpleColor, Border = true })
ProgTab:Section({ Title = L.T("sec_upgrade") })
ProgTab:Toggle({ Title = L.T("t_auto_upgrade"), Value = false, Callback = function(v) UIState["AutoUpgrades"] = v end })
ProgTab:Dropdown({ Title = L.T("t_upgrade_types"), Values = UPGRADE_TYPES, Multi = true, Value = {"Base","Treadmill"}, Callback = function(v) UIValues["UpgradeTypes"] = v end })

ProgTab:Section({ Title = L.T("sec_rewards") })
ProgTab:Toggle({ Title = L.T("t_claim_index"), Value = false, Callback = function(v) UIState["AutoClaimIndex"] = v end })
ProgTab:Toggle({ Title = L.T("t_claim_group"), Value = false, Callback = function(v) UIState["AutoClaimGroupReward"] = v end })
ProgTab:Toggle({ Title = L.T("t_claim_offline"), Value = false, Callback = function(v) UIState["AutoClaimOffline"] = v end })

ProgTab:Section({ Title = L.T("sec_equip") })
ProgTab:Toggle({ Title = L.T("t_buy_trail"), Value = false, Callback = function(v) UIState["AutoBuyTrail"] = v end })
ProgTab:Dropdown({ Title = L.T("t_trails"), Values = TrailNames, Multi = true, Value = {}, Callback = function(v) UIValues["TrailWanted"] = v end })
ProgTab:Toggle({ Title = L.T("t_eq_best_trail"), Value = false, Callback = function(v) UIState["AutoEquipBestTrail"] = v end })
ProgTab:Toggle({ Title = L.T("t_eq_best_gear"), Value = false, Callback = function(v) UIState["AutoEquipBestGear"] = v end })

ProgTab:Section({ Title = L.T("sec_train") })
ProgTab:Toggle({ Title = L.T("t_treadmill"), Value = false, Callback = function(v) UIState["AutoTreadmill"] = v end })

-- ============================================================
-- TAB 4: NHÂN VẬT (Player) - Gộp ESP, Movement, Teleport
-- ============================================================
local PlrTab = Window:Tab({ Title = L.T("tab_player"), Icon = "solar:user-bold", IconColor = PurpleColor, Border = true })
PlrTab:Section({ Title = L.T("sec_esp") })
PlrTab:Toggle({ Title = L.T("t_esp_world"), Value = false, Callback = function(v) UIState["EspWorldEggs"] = v end })
PlrTab:Toggle({ Title = L.T("t_esp_carry"), Value = false, Callback = function(v) UIState["EspCarriedEggs"] = v end })
PlrTab:Toggle({ Title = L.T("t_esp_guard"), Value = false, Callback = function(v) UIState["EspGuards"] = v end })
PlrTab:Toggle({ Title = L.T("t_esp_pet"), Value = false, Callback = function(v) UIState["EspPets"] = v end })
PlrTab:Toggle({ Title = L.T("t_esp_player"), Value = false, Callback = function(v) UIState["EspPlayers"] = v end })
PlrTab:Toggle({ Title = L.T("t_esp_machine"), Value = false, Callback = function(v) UIState["EspMachines"] = v end })
PlrTab:Toggle({ Title = L.T("t_esp_plot"), Value = false, Callback = function(v) UIState["EspPlots"] = v end })
PlrTab:Slider({ Title = L.T("t_esp_dist"), Min = 100, Max = 6000, Default = 2000, Step = 50, Callback = function(v) UIValues["EspDistance"] = v end })

PlrTab:Section({ Title = L.T("sec_move") })
PlrTab:Toggle({ Title = L.T("t_ws_override"), Value = false, Callback = function(v) UIState["WalkSpeedEnabled"] = v end })
PlrTab:Slider({ Title = L.T("t_walkspeed"), Min = 16, Max = 500, Default = 32, Step = 1, Callback = function(v) UIValues["WalkSpeed"] = v end })
PlrTab:Toggle({ Title = L.T("t_jump_override"), Value = false, Callback = function(v) UIState["JumpPowerEnabled"] = v end })
PlrTab:Slider({ Title = "Jump Power", Min = 10, Max = 500, Default = 50, Step = 1, Callback = function(v) UIValues["JumpPower"] = v end })
PlrTab:Toggle({ Title = L.T("t_inf_jump"), Value = false, Callback = function(v) UIState["InfJump"] = v end })
PlrTab:Toggle({ Title = L.T("t_noclip"), Value = false, Callback = function(v) UIState["NoClip"] = v end })
PlrTab:Toggle({ Title = L.T("t_fly"), Value = false, Callback = function(v)
    UIState["Fly"] = v
    if not v then local hum = H.getHumanoid(); if hum then hum.PlatformStand = false end end
end })
PlrTab:Slider({ Title = L.T("t_fly_speed"), Min = 10, Max = 400, Default = 60, Step = 1, Callback = function(v) UIValues["FlySpeed"] = v end })

PlrTab:Section({ Title = L.T("sec_tp") })
PlrTab:Dropdown({ Title = L.T("t_waypoint"), Values = WaypointNames, Value = "Base", Callback = function(v) UIValues["WaypointTarget"] = v end })
PlrTab:Button({ Title = L.T("t_tp_way"), Callback = function()
    task.spawn(function()
...
PlrTab:Button({ Title = L.T("t_drop_void"), Callback = function() H.teleportToVoid(); WindUI:Notify({ Title = "Void", Content = "Đã thả xuống void." }) end })

-- ============================================================
-- TAB 5: BẢO VỆ (Anti Features)
-- ============================================================
local AntiTab = Window:Tab({ Title = L.T("tab_anti"), Icon = "solar:shield-check-bold", IconColor = PurpleColor, Border = true })
AntiTab:Section({ Title = L.T("sec_anti_rag") })
AntiTab:Toggle({ Title = L.T("t_anti_rag"), Value = true, Callback = function(v) PeteAntiRagdoll = v end })
AntiTab:Toggle({ Title = L.T("t_anti_trap"), Value = false, Callback = function(v)
    IsTrapImmune = v
    if v then H.applyTrapImmunity(); WindUI:Notify({ Title = "Anti Trap", Content = "Đã bật!" }) end
end })
AntiTab:Toggle({ Title = L.T("t_instant_hold"), Value = false, Callback = function(v) H.setInstantHold(v) end })
AntiTab:Button({ Title = L.T("t_fix_lag"), Callback = function()
    H.enableFixLag()
    WindUI:Notify({ Title = "Fix Lag", Content = "Đã tối ưu!" })
end })

-- ============================================================
-- TAB 6: HỆ THỐNG (System) - Gộp Session, Performance, Webhook, About
-- ============================================================
local SysTab = Window:Tab({ Title = L.T("tab_system"), Icon = "solar:settings-bold", IconColor = PurpleColor, Border = true })
SysTab:Section({ Title = L.T("sec_session") })
SysTab:Toggle({ Title = L.T("t_anti_afk"), Value = true, Callback = function(v) UIState["AntiAfk"] = v end })
SysTab:Toggle({ Title = L.T("t_no_pause"), Value = true, Callback = function(v)
    UIState["AntiGameplayPause"] = v
    H.applyAntiGameplayPause(v)
end })
SysTab:Toggle({ Title = L.T("t_auto_rec"), Value = false, Callback = function(v) UIState["AutoReconnect"] = v end })

SysTab:Section({ Title = L.T("sec_perf") })
SysTab:Toggle({ Title = L.T("t_fps_boost"), Value = false, Callback = function(v)
    UIState["FpsBoost"] = v
    if v then H.enableFpsBoost() else H.disableFpsBoost() end
end })
SysTab:Toggle({ Title = L.T("t_disable_render"), Value = false, Callback = function(v) H.applyRendering(v) end })
SysTab:Slider({ Title = L.T("t_fps_cap"), Min = 15, Max = 360, Default = 60, Step = 1, Callback = function(v) H.applyFpsCap(v) end })

SysTab:Section({ Title = L.T("sec_webhook") })
SysTab:Toggle({ Title = L.T("t_webhook_on"), Value = false, Callback = function(v) UIState["WebhookEnabled"] = v end })
SysTab:Input({ Title = L.T("t_webhook_url"), Placeholder = "https://discord.com/api/webhooks/...", Callback = function(v) UIValues["WebhookUrl"] = v end })
SysTab:Input({ Title = L.T("t_webhook_ping"), Placeholder = "123456789012345678", Callback = function(v) UIValues["WebhookPingId"] = v end })
SysTab:Slider({ Title = L.T("t_webhook_int"), Min = 1, Max = 180, Default = 15, Step = 1, Callback = function(v) UIValues["WebhookInterval"] = v end })
SysTab:Toggle({ Title = L.T("t_webhook_dc"), Value = false, Callback = function(v) UIState["WebhookDisconnectAlerts"] = v end })
SysTab:Button({ Title = L.T("t_send_sum"), Callback = function() task.spawn(function() H.sendSummary() end) end })

SysTab:Section({ Title = L.T("sec_about") })
SysTab:Button({ Title = L.T("t_copy_dis"), Callback = function()
    if setclipboard then setclipboard(DISCORD_LINK) end
    WindUI:Notify({ Title = "ZenHubX", Content = L.T("copy_discord") })
end })
SysTab:Button({ Title = L.T("t_unload"), Callback = function()
    running = false
...
H.track(RunService.Heartbeat:Connect(function()
    ...
    if schedDue("dashboard", 2) then
        ...
        if H.isOn("WalkSpeedEnabled") then
            local hum = H.getHumanoid()
            if hum then hum.WalkSpeed = tonumber(H.optionValue("WalkSpeed", 32)) or 32 end
        end
        if H.isOn("JumpPowerEnabled") then
            local hum = H.getHumanoid()
            if hum then hum.UseJumpPower = true; hum.JumpPower = tonumber(H.optionValue("JumpPower", 50)) or 50 end
        end
...
WindUI:Notify({ Title = "ZenHubX Ultimate", Content = L.T("notify_loaded") })