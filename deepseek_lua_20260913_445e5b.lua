...
do
    ...
    conn(toggleBtn.MouseEnter:Connect(function()
        TweenService:Create(toggleBtn, TweenInfo.new(0.15), { BackgroundColor3 = Color3.fromRGB(38, 26, 52), BackgroundTransparency = 0 }):Play()
        TweenService:Create(toggleStroke, TweenInfo.new(0.15), { Color = COLORS.accent, Transparency = 0 }):Play()
    end))
    conn(toggleBtn.MouseLeave:Connect(function()
        TweenService:Create(toggleBtn, TweenInfo.new(0.15), { BackgroundColor3 = COLORS.panelBg, BackgroundTransparency = 0.15 }):Play()
        TweenService:Create(toggleStroke, TweenInfo.new(0.15), { Color = COLORS.panelBorderHi, Transparency = 0.3 }):Play()
    end))
end
...
do
    ...
    local HelpSec = UI.AddSection(HomeTab, { Title = "Quick Start" })
    ...
    UI.AddParagraph(HelpSec, { Title = "Farm flow",
        Content = " " .. STEAL_HOLD_TIME .. "" .. BYPASS_SPEED .. ") -> " })
    UI.AddParagraph(HelpSec, { Title = "Filters",
...
H.notify("ZenHubX", "Ready - press the floating icon", "Success", 5)
