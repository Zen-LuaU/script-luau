...
-- ============================================================
-- ZENHUBX KEY SYSTEM
-- Key is checked locally. It is not sent to any server.
-- ============================================================
...
-- ============================================================
-- EXTRA FEATURES (from steal egg zen hubX.lua)
-- ============================================================
local ExtrasState = {
    AntiRagdoll = false,
...
-- Auto-lock WalkSpeed every frame if SpeedBypass enabled
...
-- English -> Vietnamese labels for the existing UI.
local VI_TITLES = {
...
-- NÚT AVATAR IMAGE ID 72639013832251
...
do
    ...
    -- ========================================================
    -- VISUAL PET - client only, imported from file 2
    -- ========================================================
    ...
    -- EXTRAS (new from steal egg zen hubX.lua)
...
-- Save original English text so the language switch can translate the already-built UI.
for _, obj in ipairs(screenGui:GetDescendants()) do
    if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
        if obj.Text ~= "" then
