--[[
    ...
    Fixed: Respawn loop, safe Humanoid, language EN/VI
--]]
...
local T = {
    en = {
        ...
        tab_progress = "Progress", tab_player = "Player",
        tab_extras = "Extras", tab_system = "System",
        -- Sections
        sec_session = "Session", sec_account = "Account", sec_quick = "Quick Actions",
        sec_steal = "Steal Eggs", sec_egg_handling = "Egg Handling",
        sec_server_hop = "Server Hop", sec_task_order = "Task Order",
        sec_pets = "Pets", sec_auto_fuse = "Auto Fuse", sec_auto_sell_pets = "Auto Sell Pets",
        sec_upgrades = "Upgrades", sec_rewards = "Rewards",
        sec_equipment = "Equipment", sec_training = "Training",
        sec_esp = "ESP", sec_movement = "Movement", sec_teleports = "Teleports",
        sec_combat = "Combat / Survival", sec_interaction = "Interaction",
        sec_speed_changer = "Speed Changer", sec_perf = "Performance",
        sec_visual_pets = "Visual Pets (Client Only)",
        sec_performance = "Performance", sec_webhooks = "Webhooks", sec_about = "About",
        sec_language = "Language",
        -- Status
        st_automation = "Automation", st_current_job = "Current Job",
        st_stolen_eggs = "Stolen Eggs", st_carrying = "Carrying Egg",
        st_runtime = "Runtime", st_server = "Server",
        st_egg_inventory = "Egg Inventory", st_money = "Money",
        st_speed_power = "Speed Power", st_rebirths = "Rebirths",
        st_pets_owned = "Pets Owned",
        st_ready = "Ready", st_idle = "Idle", st_yes = "Yes", st_no = "No",
        -- Buttons
        btn_return = "Return to Base", btn_return_txt = "Return",
        btn_place_eggs = "Place Eggs", btn_place_txt = "Place",
        btn_server_hop = "Server Hop", btn_hop_txt = "Hop",
        btn_fuse_now = "Fuse Now", btn_fuse_txt = "Fuse",
        btn_hop_now = "Hop Now", btn_rejoin = "Rejoin Server",
        btn_rejoin_txt = "Rejoin", btn_copy_join = "Copy Join Script",
        btn_copy_txt = "Copy", btn_send_summary = "Send Summary Now",
        btn_send_txt = "Send", btn_copy_discord = "Copy Discord Link",
        btn_unload = "Unload Script", btn_unload_txt = "Unload",
        btn_fixlag = "Fix Lag (Clay + Remove Foliage)", btn_apply_txt = "Apply",
        btn_spawn_vpet = "Spawn Visual Pet", btn_spawn_txt = "Spawn",
        btn_clear_vpet = "Clear All Visual Pets", btn_clear_txt = "Clear",
        btn_tp_waypoint = "Teleport to Waypoint", btn_go_txt = "Go",
        -- Toggles
        tg_auto_steal_sel = "Auto Steal Selected", tg_auto_steal_sel_d = "Use filters below",
        tg_auto_steal_all = "Auto Steal All", tg_auto_steal_all_d = "Ignore rarity/mutation",
        tg_steal_big = "Steal Big Eggs",
        tg_auto_return = "Auto Return to Base",
        tg_auto_drop = "Auto Drop Held Egg",
        tg_auto_place_sel = "Auto Place Selected",
        tg_auto_place_all = "Auto Place All",
        tg_auto_hatch = "Auto Hatch Ready",
        tg_auto_sell_eggs = "Auto Sell Eggs",
        tg_auto_server_hop = "Auto Server Hop",
        tg_auto_equip_best = "Auto Equip Best Pets",
        tg_hide_own_pets = "Hide Own Pet Renders",
        tg_auto_fuse = "Auto Fuse Pets",
        tg_fuse_keep_mut = "Never Fuse Mutated",
        tg_fuse_keep_equip = "Never Fuse Equipped",
        tg_fuse_reveal = "Auto Complete Reveal",
        tg_auto_sell_pets = "Auto Sell Pets",
        tg_sell_keep_mut = "Never Sell Mutated",
        tg_sell_keep_equip = "Never Sell Equipped",
        tg_auto_upgrades = "Auto Buy Upgrades",
        tg_auto_claim_index = "Auto Claim Index",
        tg_auto_claim_group = "Auto Claim Group Reward",
        tg_auto_claim_offline = "Claim Offline Earnings",
        tg_auto_buy_trail = "Auto Buy Trail",
        tg_auto_equip_best_trail = "Auto Equip Best Trail",
        tg_auto_equip_best_gear = "Auto Equip Best Gear",
        tg_auto_treadmill = "Auto Treadmill Training",
        tg_esp_world = "World Egg ESP",
        tg_esp_carried = "Carried and Dropped Egg ESP",
        tg_esp_guards = "Guard ESP", tg_esp_pets = "Pet ESP",
        tg_esp_players = "Player ESP", tg_esp_machines = "Machine ESP",
        tg_esp_plots = "Plot ESP",
        tg_walkspeed = "Walk Speed Override",
        tg_jumppower = "Jump Power Override",
        tg_infjump = "Infinite Jump", tg_noclip = "NoClip", tg_fly = "Fly",
        tg_anti_ragdoll = "Anti-Ragdoll / Anti-Knock",
        tg_anti_trap = "Super Anti-Trap",
        tg_instant_hold = "Instant Interact (No Hold)",
        tg_free_auto_steal = "Auto Steal Free (Proximity)",
        tg_speed_changer = "Enable WalkSpeed Lock",
        tg_anti_afk = "Anti-AFK",
        tg_no_pause = "No Gameplay Paused",
        tg_auto_reconnect = "Auto Reconnect",
        tg_fps_boost = "FPS Boost",
        tg_disable_render = "Disable 3D Rendering",
        tg_webhook = "Enable Webhooks",
        -- Dropdowns
        dd_areas = "Areas", dd_rarities = "Rarities", dd_mutations = "Mutations",
        dd_target_priority = "Target Priority",
        dd_lifecycle_rarities = "Lifecycle Rarities",
        dd_lifecycle_mutations = "Lifecycle Mutations",
        dd_sell_egg_rarities = "Sell Rarities",
        dd_hop_when = "Hop When",
        dd_fuse_rarities = "Fuse Rarities", dd_fuse_mutations = "Fuse Mutations",
        dd_fuse_target = "Pick Group By",
        dd_sell_rarities = "Sell Rarities", dd_sell_mutations = "Sell Mutations",
        dd_upgrade_types = "Upgrade Types", dd_trails = "Trails",
        dd_waypoint = "Waypoint",
        dd_anti_ragdoll_mode = "Camera Mode",
        -- Sliders
        sl_big_egg_scale = "Minimum Big Egg Size",
        sl_sell_interval = "Sell Interval",
        sl_wait_hop = "Wait Before Hop",
        sl_fuse_max_scale = "Maximum Scale to Fuse",
        sl_fuse_keep_per = "Keep Per Pet Type",
        sl_fuse_interval = "Fuse Interval",
        sl_sell_max_scale = "Maximum Scale to Sell",
        sl_sell_int = "Sell Interval",
        sl_esp_dist = "Render Distance",
        sl_walkspeed = "Walk Speed", sl_jumppower = "Jump Power",
        sl_flyspeed = "Fly Speed",
        sl_speed_val = "WalkSpeed Value",
        sl_vpet_radius = "Orbit Radius", sl_vpet_speed = "Orbit Speed",
        sl_fps_cap = "FPS Cap",
        sl_webhook_int = "Summary Interval",
        -- Inputs
        in_vpet_name = "Pet Name",
        in_webhook_url = "Webhook URL", in_webhook_ping = "Webhook Ping User ID",
        -- Notifications
        n_ready = "Ready - press Z button",
        n_discord_copied = "Discord link copied",
        n_base_unavail = "Base unavailable",
        n_waypoint_unavail = "Waypoint unavailable",
        n_waypoint_fail = "Waypoint failed",
        n_fixlag_applied = "Fix Lag applied",
        n_enter_pet = "Enter a pet name",
        n_join_copied = "Join script copied",
        n_summary_sent = "Summary sent",
        n_summary_fail = "Summary failed",
        n_lang_changed = "Language changed to English",
        -- Divider
        dv_target_filter = "Target filters",
        dv_carry_behavior = "Carry behavior",
        dv_egg_selling = "Egg selling",
        dv_danger = "Danger Zone",
        -- Misc
        all = "All",
        priority = "Priority",
        about_dev = "Script Dev",
    },
    vi = {
        discord = "Discord",
        tab_home = "Trang chính", tab_farm = "Farm", tab_pets = "Thú cưng",
        tab_progress = "Tiến trình", tab_player = "Nhân vật",
        tab_extras = "Tính năng thêm", tab_system = "Hệ thống",
        sec_session = "Phiên", sec_account = "Tài khoản", sec_quick = "Hành động nhanh",
        sec_steal = "Trộm trứng", sec_egg_handling = "Xử lý trứng",
        sec_server_hop = "Đổi server", sec_task_order = "Thứ tự tác vụ",
        sec_pets = "Thú cưng", sec_auto_fuse = "Tự động Fusion", sec_auto_sell_pets = "Tự bán thú",
        sec_upgrades = "Nâng cấp", sec_rewards = "Phần thưởng",
        sec_equipment = "Trang bị", sec_training = "Luyện tập",
        sec_esp = "ESP", sec_movement = "Di chuyển", sec_teleports = "Dịch chuyển",
        sec_combat = "Chiến đấu / Sinh tồn", sec_interaction = "Tương tác",
        sec_speed_changer = "Chỉnh tốc độ", sec_perf = "Hiệu năng",
        sec_visual_pets = "Thú cưng ảo (Chỉ hiển thị)",
        sec_performance = "Hiệu năng", sec_webhooks = "Webhook", sec_about = "Giới thiệu",
        sec_language = "Ngôn ngữ",
        st_automation = "Tự động", st_current_job = "Tác vụ hiện tại",
        st_stolen_eggs = "Trứng đã trộm", st_carrying = "Đang mang trứng",
        st_runtime = "Thời gian chạy", st_server = "Server",
        st_egg_inventory = "Túi trứng", st_money = "Tiền",
        st_speed_power = "Sức mạnh tốc độ", st_rebirths = "Tái sinh",
        st_pets_owned = "Thú sở hữu",
        st_ready = "Sẵn sàng", st_idle = "Đang chờ", st_yes = "Có", st_no = "Không",
        btn_return = "Về căn cứ", btn_return_txt = "Về",
        btn_place_eggs = "Đặt trứng", btn_place_txt = "Đặt",
        btn_server_hop = "Đổi server", btn_hop_txt = "Đổi",
        btn_fuse_now = "Fusion ngay", btn_fuse_txt = "Fusion",
        btn_hop_now = "Đổi server ngay", btn_rejoin = "Vào lại server",
        btn_rejoin_txt = "Vào lại", btn_copy_join = "Sao chép Script vào server",
        btn_copy_txt = "Sao chép", btn_send_summary = "Gửi tổng kết ngay",
        btn_send_txt = "Gửi", btn_copy_discord = "Sao chép Link Discord",
        btn_unload = "Tắt Script", btn_unload_txt = "Tắt",
        btn_fixlag = "Giảm lag (Đất sét + Xóa cây)", btn_apply_txt = "Áp dụng",
        btn_spawn_vpet = "Tạo thú ảo", btn_spawn_txt = "Tạo",
        btn_clear_vpet = "Xóa tất cả thú ảo", btn_clear_txt = "Xóa",
        btn_tp_waypoint = "Dịch chuyển tới điểm", btn_go_txt = "Đi",
        tg_auto_steal_sel = "Tự trộm theo bộ lọc", tg_auto_steal_sel_d = "Dùng bộ lọc bên dưới",
        tg_auto_steal_all = "Tự trộm tất cả", tg_auto_steal_all_d = "Bỏ qua độ hiếm/đột biến",
        tg_steal_big = "Trộm trứng to",
        tg_auto_return = "Tự về căn cứ",
        tg_auto_drop = "Tự thả trứng đang mang",
        tg_auto_place_sel = "Tự đặt theo bộ lọc",
        tg_auto_place_all = "Tự đặt tất cả",
        tg_auto_hatch = "Tự ấp trứng sẵn sàng",
        tg_auto_sell_eggs = "Tự bán trứng",
        tg_auto_server_hop = "Tự đổi server",
        tg_auto_equip_best = "Tự trang bị thú mạnh nhất",
        tg_hide_own_pets = "Ẩn thú của mình",
        tg_auto_fuse = "Tự Fusion thú",
        tg_fuse_keep_mut = "Không Fusion thú đột biến",
        tg_fuse_keep_equip = "Không Fusion thú đang dùng",
        tg_fuse_reveal = "Tự hoàn tất hiển thị",
        tg_auto_sell_pets = "Tự bán thú",
        tg_sell_keep_mut = "Không bán thú đột biến",
        tg_sell_keep_equip = "Không bán thú đang dùng",
        tg_auto_upgrades = "Tự mua nâng cấp",
        tg_auto_claim_index = "Tự nhận Index",
        tg_auto_claim_group = "Tự nhận thưởng Group",
        tg_auto_claim_offline = "Nhận thu nhập offline",
        tg_auto_buy_trail = "Tự mua Trail",
        tg_auto_equip_best_trail = "Tự trang bị Trail tốt nhất",
        tg_auto_equip_best_gear = "Tự trang bị Gear tốt nhất",
        tg_auto_treadmill = "Tự luyện Treadmill",
        tg_esp_world = "ESP trứng trên map",
        tg_esp_carried = "ESP trứng đang mang / đã thả",
        tg_esp_guards = "ESP bảo vệ", tg_esp_pets = "ESP thú",
        tg_esp_players = "ESP người chơi", tg_esp_machines = "ESP máy móc",
        tg_esp_plots = "ESP khu đất",
        tg_walkspeed = "Ghi đè tốc độ đi",
        tg_jumppower = "Ghi đè lực nhảy",
        tg_infjump = "Nhảy vô hạn", tg_noclip = "Xuyên vật thể", tg_fly = "Bay",
        tg_anti_ragdoll = "Chống ngã / Chống văng",
        tg_anti_trap = "Chống bẫy",
        tg_instant_hold = "Tương tác tức thì (Không giữ)",
        tg_free_auto_steal = "Tự trộm Free (Proximity)",
        tg_speed_changer = "Khóa tốc độ đi",
        tg_anti_afk = "Chống AFK",
        tg_no_pause = "Không bị tạm dừng",
        tg_auto_reconnect = "Tự kết nối lại",
        tg_fps_boost = "Tăng FPS",
        tg_disable_render = "Tắt render 3D",
        tg_webhook = "Bật Webhook",
        dd_areas = "Khu vực", dd_rarities = "Độ hiếm", dd_mutations = "Đột biến",
        dd_target_priority = "Ưu tiên mục tiêu",
        dd_lifecycle_rarities = "Độ hiếm vòng đời",
        dd_lifecycle_mutations = "Đột biến vòng đời",
        dd_sell_egg_rarities = "Độ hiếm bán",
        dd_hop_when = "Đổi khi",
        dd_fuse_rarities = "Độ hiếm Fusion", dd_fuse_mutations = "Đột biến Fusion",
        dd_fuse_target = "Chọn nhóm theo",
        dd_sell_rarities = "Độ hiếm bán", dd_sell_mutations = "Đột biến bán",
        dd_upgrade_types = "Loại nâng cấp", dd_trails = "Trail",
        dd_waypoint = "Điểm đến",
        dd_anti_ragdoll_mode = "Chế độ Camera",
        sl_big_egg_scale = "Kích thước trứng to tối thiểu",
        sl_sell_interval = "Chu kỳ bán",
        sl_wait_hop = "Chờ trước khi đổi",
        sl_fuse_max_scale = "Kích thước tối đa Fusion",
        sl_fuse_keep_per = "Giữ mỗi loại thú",
        sl_fuse_interval = "Chu kỳ Fusion",
        sl_sell_max_scale = "Kích thước tối đa bán",
        sl_sell_int = "Chu kỳ bán",
        sl_esp_dist = "Khoảng cách render",
        sl_walkspeed = "Tốc độ đi", sl_jumppower = "Lực nhảy",
        sl_flyspeed = "Tốc độ bay",
        sl_speed_val = "Giá trị tốc độ",
        sl_vpet_radius = "Bán kính quay", sl_vpet_speed = "Tốc độ quay",
        sl_fps_cap = "Giới hạn FPS",
        sl_webhook_int = "Chu kỳ tổng kết",
        in_vpet_name = "Tên thú",
        in_webhook_url = "URL Webhook", in_webhook_ping = "ID người dùng cần ping",
        n_ready = "Sẵn sàng - nhấn nút Z",
        n_discord_copied = "Đã sao chép link Discord",
        n_base_unavail = "Không tìm thấy căn cứ",
        n_waypoint_unavail = "Không tìm thấy điểm đến",
        n_waypoint_fail = "Không thể tới điểm đến",
        n_fixlag_applied = "Đã áp dụng giảm lag",
        n_enter_pet = "Nhập tên thú",
        n_join_copied = "Đã sao chép script vào server",
        n_summary_sent = "Đã gửi tổng kết",
        n_summary_fail = "Gửi thất bại",
        n_lang_changed = "Đã đổi ngôn ngữ sang Tiếng Việt",
        dv_target_filter = "Bộ lọc mục tiêu",
        dv_carry_behavior = "Hành vi mang trứng",
        dv_egg_selling = "Bán trứng",
        dv_danger = "Vùng nguy hiểm",
        all = "Tất cả",
        priority = "Ưu tiên",
        about_dev = "Nhà phát triển",
    },
}
...
function H.placeRoot(root, cf)
    ...
    -- FIX: không làm gì nếu nhân vật đã chết
...
-- ============================================================
-- FIX: prepareStealHumanoid AN TOÀN, không clone/destroy Humanoid
-- ============================================================
function H.prepareStealHumanoid()
    ...
    -- Vô hiệu hóa script gây cản trở (nếu có) thay vì xóa Humanoid
    pcall(function()
    ...
    -- Cấu hình thuộc tính an toàn
    humanoid.AutoRotate = true
    humanoid.PlatformStand = false
    humanoid.Sit = false
    humanoid.WalkSpeed = H.stealSpeed()

    -- Gán lại camera nếu cần
...
-- ============================================================
-- FIX: bypassMoveTo có kiểm tra Health, không gây chết liên tục
-- ============================================================
function H.bypassMoveTo(position, keepGoing, speed)
    ...
    humanoid.Sit = false; humanoid.PlatformStand = true

    local targetY = H.groundedY(position.X, position.Z, root.Position.Y)
    local dest = Vector3.new(position.X, targetY, position.Z)
    if (root.Position - dest).Magnitude <= BASE_RETURN_ARRIVE then
        if humanoid.Health > 0 then humanoid.PlatformStand = false end
        return true
    end
    ...
    while running and os.clock() < deadline do
        ...
        -- FIX: thoát nếu nhân vật chết hoặc mất root
...
function H.disableFpsBoost()
    ...
    if snapshot.Terrain and snapshot.Terrain.Parent then
        ...
        snapshot.Terrain.WaterReflectance = snapshot.WaterWaveReflectance
    end
...
-- ============================================================
-- FIX: Anti-Ragdoll chỉ can thiệp khi nhân vật còn sống
-- ============================================================
...
RunService.Stepped:Connect(function()
    ...
    -- CHỈ CAN THIỆP KHI NHÂN VẬT CÒN SỐNG
...
-- ============================================================
-- FIX: Reset toàn bộ trạng thái khi Respawn
-- ============================================================
H.track(LocalPlayer.CharacterAdded:Connect(function(newCharacter)
    -- Reset tất cả trạng thái tạm
    IsCarryingEgg = false
    TreadmillTrainingActive = false
    ...
    -- Chờ Humanoid nạp xong và trả trạng thái bình thường
    ...
    pcall(function() newCharacter:WaitForChild("HumanoidRootPart", 5) end)

    -- Xóa BodyVelocity/BodyGyro còn sót lại
...
UI.__activeTab = nil
UI.__connections = {}
UI.__texts = {}  -- lưu TextLabel để update khi đổi ngôn ngữ
UI.__buttons = {} -- lưu nút có text động
...
-- Đăng ký TextLabel để update theo ngôn ngữ
...
-- Hàm update toàn bộ text khi đổi ngôn ngữ
function UI.UpdateLanguage()
    ...
    for _, entry in ipairs(UI.__tabButtons or {}) do
...
function UI.AddToggle(parent, opts)
    ...
    if opts.Description then
        ...
        d.Text = opts.Description
        d.Parent = row
        if opts.LangKeyDesc then regText(d, opts.LangKeyDesc) end
    end
...
do
    ...
    refs.jobRow = UI.AddStatus(SessionSec, { Title = "Current Job", LangKey = "st_current_job", Value = "Idle" })
    ...
    UI.AddToggle(StealSec, { Id = "AutoStealSelected", Title = "Auto Steal Selected", LangKey = "tg_auto_steal_sel", Description = "Use filters below", Default = false })
    UI.AddToggle(StealSec, { Id = "AutoStealAll", Title = "Auto Steal All", LangKey = "tg_auto_steal_all", Description = "Ignore rarity/mutation", Default = false })
    ...
    -- Language dropdown (không có LangKey vì tên riêng)
    local langDropdown = UI.AddDropdown(LangSec, {
        Id = "LangSelect",
        Title = "Language",
