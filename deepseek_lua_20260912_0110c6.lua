--[[
    zen hubXsteal
    Fixed: removed death-loop features, added safe SetupCharacter, Void reset, Hop GUI
    Language: EN / VI
--]]
...
local T = {
    en = {
        ...
        sec_danger="Danger Zone",sec_void="Void Reset",sec_hop_gui="Server Hop GUI",
        ...
        n_void="Teleported to void",n_hop_gui_open="Server Hop GUI opened",n_hop_now="Hopping server...",
    ...
    vi = {
        ...
        sec_danger="Vùng nguy hiểm",sec_void="Reset Void",sec_hop_gui="Giao diện Đổi Server",
        ...
        n_void="Đã thả xuống void",n_hop_gui_open="Đã mở giao diện Đổi Server",n_hop_now="Đang đổi server...",
...
-- ============================================================
-- SETUP CHARACTER (SAFE) — từ file zenhubX gốc
-- ============================================================
local PeteSettings = {
    AntiRagdoll = true,
...
-- ============================================================
-- FIX: KHÔNG clone/destroy Humanoid — chỉ disable script cản trở
-- ============================================================
...
-- ============================================================
-- FIX: bypassMoveTo — KHÔNG dùng BodyVelocity + PlatformStand lâu dài
-- Thay bằng direct CFrame step theo Heartbeat (an toàn, không gây chết)
-- ============================================================
...
-- ============================================================
-- SERVER HOP GUI (từ file zenhubX)
-- ============================================================
local function OpenServerHopGUI()
    ...
    Title.TextColor3 = Color3.fromRGB(220, 130, 255)
    Title.TextSize = 13
    ...
    NowLabel.TextColor3 = Color3.fromRGB(150, 220, 150)
    ...
    MaxLabel.TextColor3 = Color3.fromRGB(180, 160, 210)
    ...
    MaxBox.BackgroundColor3 = Color3.fromRGB(45, 30, 70)
    MaxBox.BorderSizePixel = 0
    MaxBox.Font = Enum.Font.GothamBold
    MaxBox.Text = "5"
    MaxBox.TextColor3 = Color3.fromRGB(245, 235, 255)
    MaxBox.TextSize = 14
    ...
    HopBtn.BackgroundColor3 = Color3.fromRGB(170, 60, 255)
...
-- Anti-Ragdoll (từ file zenhubX, có health check)
...
-- Anti-Knock (từ file zenhubX — xóa constraint vật lý)
...
-- Speed Changer (safe — không clone Humanoid)
local SpeedConfig = { Enabled = false, Value = 300, OriginalSpeed = 16 }
RunService.Stepped:Connect(function()
...
-- Free Auto Steal (proximity prompt 35 studs — từ file zenhubX)
local PromptCache = {}
...
-- ============================================================
-- CHARACTER RESPAWN RESET (an toàn)
-- ============================================================
