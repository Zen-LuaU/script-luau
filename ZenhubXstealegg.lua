...
local VI_TO_EN = {
    ...
    ["Tự gộp"]="Auto Fuse", ["Tự bán pet"]="Auto Sell Pets",
    ...
    ["Không bán pet biến thể"]="Never Sell Mutated", ["Không bán pet đang trang bị"]="Never Sell Equipped",
    ["Scale tối đa để bán"]="Maximum Scale to Sell",
...
-- Lưu text gốc Tiếng Việt cho hệ thống chuyển đổi ngôn ngữ
for _, obj in ipairs(screenGui:GetDescendants()) do
    if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
        if obj.Text ~= "" then
