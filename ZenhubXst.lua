--[[
    ...
    [MOD] Custom Speed 100-800 + Vietnamese Localization
--]]
...
-- ============================================================
-- LANGUAGE (đã bổ sung key mới cho Custom Speed)
-- ============================================================
local LANG = {
    Current = "en",
    Strings = {
        vi = {
            ...
            speedOn = "Đã bật tốc độ tùy chỉnh",
            speedOff = "Đã tắt tốc độ tùy chỉnh",
            speedSet = "Đã đặt tốc độ: ",
        },
        en = {
            ...
            speedOn = "Custom speed enabled",
            speedOff = "Custom speed disabled",
...
-- ============================================================
-- BẢNG DỊCH TIẾNG VIỆT (đã bổ sung Custom Speed)
-- ============================================================
local VI_TITLES = {
-- Home
["Home"]="Trang chủ",["Session"]="Phiên chơi",["Account"]="Tài khoản",["Quick Actions"]="Thao tác nhanh",
["Automation"]="Tự động hoá",["Current Job"]="Tác vụ hiện tại",["Stolen Eggs"]="Trứng đã trộm",
["Carrying Egg"]="Đang mang trứng",["Runtime"]="Thời gian chạy",["Server"]="Máy chủ",
["Egg Inventory"]="Kho trứng",["Money"]="Tiền",["Speed Power"]="Sức mạnh tốc độ",
["Rebirths"]="Tái sinh",["Pets Owned"]="Pet sở hữu",["Return to Base"]="Về căn cứ",
["Place Eggs"]="Đặt trứng",["Server Hop"]="Đổi server",["Fuse Now"]="Gộp ngay",
["Live status"]="Trạng thái trực tiếp",["Save data"]="Dữ liệu lưu",

-- Farm
["Farm"]="Farm",["Steal Eggs"]="Trộm trứng",["Egg Handling"]="Xử lý trứng",
["Task Order"]="Thứ tự tác vụ",
["Auto Steal Selected"]="Tự trộm mục đã chọn",
["Auto Steal All"]="Tự trộm tất cả",
["Steal Big Eggs"]="Trộm trứng lớn",
["Target filters"]="Bộ lọc mục tiêu",
["Areas"]="Khu vực",["Rarities"]="Độ hiếm",["Mutations"]="Biến thể",
["Target Priority"]="Ưu tiên mục tiêu",
["Minimum Big Egg Size"]="Kích thước trứng lớn tối thiểu",
["Carry behavior"]="Cách mang trứng",
["Auto Return to Base"]="Tự về căn cứ",
["Auto Drop Held Egg"]="Tự thả trứng đang cầm",
["Auto Place Selected"]="Tự đặt mục đã chọn",
["Auto Place All"]="Tự đặt tất cả",
["Auto Hatch Ready"]="Tự ấp trứng sẵn sàng",
["Lifecycle Rarities"]="Độ hiếm vòng đời",
["Lifecycle Mutations"]="Biến thể vòng đời",
["Egg selling"]="Bán trứng",
["Auto Sell Eggs"]="Tự bán trứng",
["Sell Rarities"]="Độ hiếm bán",
["Sell Interval"]="Chu kỳ bán",
["Auto Server Hop"]="Tự đổi server",
["Hop When"]="Đổi server khi",
["Wait Before Hop"]="Chờ trước khi đổi",
["Hop Now"]="Đổi server ngay",
["Use filters below"]="Dùng bộ lọc bên dưới",
["Ignore rarity/mutation"]="Bỏ qua độ hiếm/biến thể",
["Runs the first ready task in this order."]="Chạy tác vụ sẵn sàng đầu tiên theo thứ tự này.",

-- Pets
["Pets"]="Pet",["Auto Fuse"]="Tự gộp",["Auto Sell Pets"]="Tự bán pet",
["Auto Equip Best Pets"]="Tự trang bị pet tốt nhất",
["Hide Own Pet Renders"]="Ẩn pet của mình",
["Auto Fuse Pets"]="Tự gộp pet",
["Fuse Rarities"]="Độ hiếm gộp",
["Fuse Mutations"]="Biến thể gộp",
["Pick Group By"]="Nhóm theo",
["Never Fuse Mutated"]="Không gộp pet biến thể",
["Never Fuse Equipped"]="Không gộp pet đang trang bị",
["Auto Complete Reveal"]="Tự hoàn tất khám phá",
["Maximum Scale to Fuse"]="Scale tối đa để gộp",
["Keep Per Pet Type"]="Giữ mỗi loại pet",
["Fuse Interval"]="Chu kỳ gộp",
["Sell Mutations"]="Biến thể bán",
["Never Sell Mutated"]="Không bán pet biến thể",
["Never Sell Equipped"]="Không bán pet đang trang bị",
["Maximum Scale to Sell"]="Scale tối đa để bán",
["Visual Pet"]="Pet ảo",
["Refresh Pet List"]="Làm mới danh sách pet",
["Custom Name"]="Tên tùy chỉnh",
["Orbit Radius"]="Bán kính xoay",
["Orbit Speed"]="Tốc độ xoay",
["Spawn Pet"]="Triệu hồi pet",
["Remove Last Pet"]="Xoá pet cuối",
["Remove All Pets"]="Xoá tất cả pet",

-- Progress
["Progress"]="Tiến trình",["Upgrades"]="Nâng cấp",["Rewards"]="Phần thưởng",
["Equipment"]="Trang bị",["Training"]="Huấn luyện",
["Auto Buy Upgrades"]="Tự mua nâng cấp",
["Upgrade Types"]="Loại nâng cấp",
["Auto Claim Index"]="Tự nhận Index",
["Auto Claim Group Reward"]="Tự nhận thưởng nhóm",
["Claim Offline Earnings"]="Nhận tiền offline",
["Auto Buy Trail"]="Tự mua Trail",
["Trails"]="Trail",
["Auto Equip Best Trail"]="Tự trang bị Trail tốt nhất",
["Auto Equip Best Gear"]="Tự trang bị Gear tốt nhất",
["Auto Treadmill Training"]="Tự tập máy chạy",

-- Player
["Player"]="Người chơi",["ESP"]="ESP",["Movement"]="Di chuyển",["Teleports"]="Dịch chuyển",
["World Egg ESP"]="ESP trứng trên map",
["Carried and Dropped Egg ESP"]="ESP trứng đang cầm/thả",
["Guard ESP"]="ESP bảo vệ",
["Pet ESP"]="ESP pet",
["Player ESP"]="ESP người chơi",
["Machine ESP"]="ESP máy",
["Plot ESP"]="ESP khu đất",
["Render Distance"]="Khoảng cách hiển thị",
["Walk Speed Override"]="Ghi đè tốc độ chạy",
["Walk Speed"]="Tốc độ chạy",
["Custom Speed Override"]="Bật tốc độ tùy chỉnh",
["Custom Speed"]="Tốc độ tùy chỉnh",
["Jump Power Override"]="Ghi đè lực nhảy",
["Jump Power"]="Lực nhảy",
["Infinite Jump"]="Nhảy vô hạn",
["NoClip"]="Xuyên tường",
["Fly"]="Bay",
["Fly Speed"]="Tốc độ bay",
["Waypoint"]="Điểm đánh dấu",
["Teleport to Waypoint"]="Dịch chuyển tới điểm",

-- Extras
["Extras"]="Bổ sung",["Character"]="Nhân vật",["World"]="Thế giới",
["Speed Bypass"]="Bypass tốc độ",
["Anti Trap"]="Chống bẫy",
["Anti-Ragdoll"]="Chống ragdoll",
["Instant Interact"]="Tương tác tức thì",
["Tele Guiado (LookRocket)"]="Tele Guiado (LookRocket)",
["Fix Lag (Clay)"]="Giảm lag (Clay)",
["Anti Trap (Delete)"]="Chống bẫy (Xoá)",
["Hop Low-Pop Server (1-5 players)"]="Đổi server ít người (1-5)",
["Speed Value"]="Giá trị tốc độ",
["Lock WalkSpeed"]="Khoá tốc độ chạy",
["Apply Speed Bypass (Clone Humanoid)"]="Áp dụng bypass tốc độ",

-- System
["System"]="Hệ thống",["Performance"]="Hiệu năng",["Settings"]="Cài đặt",
["Social"]="Liên kết",["Webhooks"]="Webhook",["About"]="Thông tin",
["Anti-AFK"]="Chống AFK",
["No Gameplay Paused"]="Không tạm dừng gameplay",
["Auto Reconnect"]="Tự kết nối lại",
["Rejoin Server"]="Vào lại server",
["Copy Join Script"]="Sao chép script vào server",
["FPS Boost"]="Tăng FPS",
["Disable 3D Rendering"]="Tắt render 3D",
["FPS Cap"]="Giới hạn FPS",
["Language / Ngôn ngữ"]="Ngôn ngữ",
["Copy Discord Link"]="Sao chép link Discord",
["Copy TikTok ID"]="Sao chép TikTok ID",
["Enable Webhooks"]="Bật Webhook",
["Webhook URL"]="URL Webhook",
["Ping User ID"]="ID người nhận ping",
["Summary Interval"]="Chu kỳ tổng kết",
["List Spawned Eggs"]="Liệt kê trứng đã spawn",
["Disconnect Alerts"]="Cảnh báo mất kết nối",
["Send Summary Now"]="Gửi tổng kết ngay",
["Script Dev"]="Nhà phát triển script",
["UI"]="Giao diện",
["Discord"]="Discord",
["TikTok"]="TikTok",
...
-- Status / values
["Ready"]="Sẵn sàng",["Idle"]="Chờ",["Yes"]="Có",["No"]="Không",
["All"]="Tất cả",["Run"]="Chạy",["Return"]="Về",["Place"]="Đặt",
["Hop"]="Đổi",["Fuse"]="Gộp",["Send"]="Gửi",["Copy"]="Sao chép",
["Apply"]="Áp dụng",["Go"]="Đi",["Rejoin"]="Vào lại",
["Refresh"]="Làm mới",["Spawn"]="Triệu hồi",["Remove"]="Xoá",
["Remove All"]="Xoá hết",
["Rarest"]="Hiếm nhất",["Nearest"]="Gần nhất",["Furthest"]="Xa nhất",
["Biggest Size"]="To nhất",
["Highest Rarity"]="Độ hiếm cao nhất",["Lowest Rarity"]="Độ hiếm thấp nhất",
["Most Duplicates"]="Nhiều trùng nhất",
["Base"]="Căn cứ",["Treadmill"]="Máy chạy",
["Pet Area"]="Khu pet",["Fuse Machine"]="Máy gộp",["Lobby Entry"]="Cửa vào sảnh",
["No Matching Eggs"]="Không có trứng khớp",
["Timed Interval"]="Chu kỳ thời gian",
["After Steal Count"]="Sau số trứng đã trộm",
["Golden"]="Vàng",["Rainbow"]="Cầu vồng",["Silver"]="Bạc",
["Common"]="Thường",["Uncommon"]="Ít gặp",["Rare"]="Hiếm",["Epic"]="Sử thi",
["Legendary"]="Huyền thoại",["Mythic"]="Thần thoại",["Cosmic"]="Vũ trụ",
["Secret"]="Bí mật",["Eternal"]="Vĩnh cửu",["Divine"]="Thần thánh",
["English"]="Tiếng Anh",["Tiếng Việt"]="Tiếng Việt",
["Scanning..."]="Đang quét...",
}

-- ============================================================
-- Hàm dịch áp dụng cho toàn bộ UI (đã hỗ trợ placeholder)
-- ============================================================
local function applyLanguageToUI()
    ...
    -- Placeholder
    for _, obj in ipairs(screenGui:GetDescendants()) do
        if obj:IsA("TextBox") and obj:GetAttribute("ZenOriginalPlaceholder") then
            local orig = tostring(obj:GetAttribute("ZenOriginalPlaceholder"))
            if LANG.Current == "vi" then
                obj.PlaceholderText = VI_TITLES[orig] or orig
            else
                obj.PlaceholderText = orig
            end
        end
    end
end
...
-- ============================================================
-- UI BUILD (giữ nguyên toàn bộ gốc)
-- ============================================================
...
do
    ...
    local function spawnVisualPet(name)
        ...
        if not source then
            H.notify("Visual Pet", "Không tìm thấy pet: " .. tostring(name), "Warning", 4)
            return
        end
        ...
        H.notify("Visual Pet", "Đã spawn " .. tostring(name) .. " (client only).", "Success", 3)
    end
    ...
    UI.AddButton(PetsOverview, {
        ...
        Callback = function()
            ...
            if #list == 0 then
                H.notify("Visual Pet", "Chưa tìm thấy model pet.", "Warning", 4)
                return
            end
    ...
    UI.AddButton(PetsOverview, {
        ...
        Callback = function()
            if VisualPetState.inputName == "" or VisualPetState.inputName == "Scanning..." then
                H.notify("Visual Pet", "Hãy chọn hoặc nhập tên pet.", "Warning", 4)
                return
            end
    ...
    -- ========================================================
    -- [MOD 1] SLIDER TỐC ĐỘ 100-800 + TOGGLE BẬT/TẮT
    -- ========================================================
    ...
    UI.AddToggle(MoveSec, {
        Id = "CustomSpeedEnabled",
        Title = "Custom Speed Override",
        Description = "Bật để dùng tốc độ tùy chỉnh 100-800",
        Default = false
    })

    UI.AddSlider(MoveSec, {
        Id = "CustomSpeed",
        Title = "Custom Speed",
        Min = 100,
        Max = 800,
        ...
        Suffix = " studs/s",
        Callback = function(v)
            if UI.GetState("CustomSpeedEnabled") == true then
                local humanoid = H.getHumanoid()
                if humanoid then
                    humanoid.WalkSpeed = math.clamp(tonumber(v) or 300, 100, 800)
                end
            end
        end
    })
    ...
    -- ========================================================
    -- [MOD 2] LANGUAGE DROPDOWN VỚI VIỆT HOÁ
    -- ========================================================
...
-- Lưu Text gốc + Placeholder gốc để hỗ trợ việt hoá
for _, obj in ipairs(screenGui:GetDescendants()) do
    if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
        if obj.Text ~= "" then
    ...
    if obj:IsA("TextBox") and obj.PlaceholderText ~= "" then
        pcall(function() obj:SetAttribute("ZenOriginalPlaceholder", obj.PlaceholderText) end)
    end
end

-- ========================================================
-- [MOD 3] UI.OnChange HANDLERS CHO CUSTOM SPEED
-- ========================================================
UI.OnChange("CustomSpeed", function(v)
    if UI.GetState("CustomSpeedEnabled") == true then
        local humanoid = H.getHumanoid()
        if humanoid then
            humanoid.WalkSpeed = math.clamp(tonumber(v) or 300, 100, 800)
...
UI.OnChange("CustomSpeedEnabled", function(state)
    local humanoid = H.getHumanoid()
    if not humanoid then return end
    if state then
        humanoid.WalkSpeed = math.clamp(tonumber(H.optionValue("CustomSpeed", 300)) or 300, 100, 800)
        H.notify("Tốc độ", L("speedOn"), "Success", 2)
    else
        H.notify("Tốc độ", L("speedOff"), "Info", 2)
    end
end)
-- ========================================================
...
H.track(RunService.Heartbeat:Connect(function()
    ...
    if schedulerDue("dashboard", 2) then
        ...
        -- ====================================================
        -- [MOD 4] ÁP DỤNG TỐC ĐỘ TÙY CHỈNH (100-800)
        -- Ưu tiên CustomSpeedEnabled > WalkSpeedEnabled
        -- ====================================================
        if H.isOn("CustomSpeedEnabled") then
            local humanoid = H.getHumanoid()
            if humanoid then
                local spd = math.clamp(tonumber(H.optionValue("CustomSpeed", 300)) or 300, 100, 800)
                if humanoid.WalkSpeed ~= spd then
                    humanoid.WalkSpeed = spd
                end
            end
        elseif H.isOn("WalkSpeedEnabled") and not ExtrasState.SpeedBypass then
            local humanoid = H.getHumanoid()
            if humanoid then
                humanoid.WalkSpeed = math.clamp(tonumber(H.optionValue("WalkSpeed", 32)) or 32, 16, MAX_SAFE_SPEED)
            end
        end
        -- ====================================================
...
-- ============================================================
-- [MOD 5] ÁP DỤNG VIỆT HOÁ NẾU MẶC ĐỊNH LÀ TIẾNG VIỆT
-- (mặc định English; nếu bạn muốn mặc định Tiếng Việt thì đổi "en" -> "vi" trong LANG.Current ở trên)
-- ============================================================
task.defer(function()
    if LANG.Current == "vi" then applyLanguageToUI() end
end)
